 <div class="content-wrapper">  
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Haber Ekleme Sayfası</h1>
                </div>
	...
	<div class="container-fluid">
	    <div class="row" style="padding-right:10px;">
	        <div class="col-md-12">
				<a href="<?=SITE?>haber-liste" class="btn btn-success" style="float:right; margin-bottom:10px;"><i class="fas fa-book-open"> HABER LİSTESİ</i></a>
		    </div>    
		</div>
    </div>
		...
		if($_POST)
		{
			if(!empty($_POST["baslik"])&& (!empty($_POST["aciklama"]))) 
			{
				...
				if(!empty($_FILES["resim"]["name"]))
				{
					...
					if($yukle!=false)
					{
						$ekle=$DB->SorguCalistir("INSERT INTO haberler ","SET Baslik=?,Aciklama=?,Resim=?, Tarih=?",
				...
				{
			        $ekle=$DB->SorguCalistir("INSERT INTO haberler ","SET Baslik=?,Aciklama=?, Tarih=?",
	        ...
	        <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Haber</label> 
                        <input type="text" class="form-control" style="border-color:#f0dc82;" name="baslik" required="required" placeholder="Haber Adı Giriniz ...">
				    </div>
