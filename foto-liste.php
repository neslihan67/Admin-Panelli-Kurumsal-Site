	...
	<div class="content-wrapper">
	    <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Resimler Listesi</h1>
                    </div>
		...
		<div style="margin-left:10px;" class="container">
			<div class="row">
					...
					<?php
					$veri=$DB->VeriGetir("resimgalerisi","","","ORDER BY ID ASC");
					if($veri!=false)
					{
						for($i=0;$i<count($veri);$i++)
					   {
						...
						<hr>
							<div style="text-align:center;" class="row">
								<a href="<?=SITE?>foto-duzenle/<?=$veri[$i]["ID"]?>" style="text-align:center;" class="btn btn-warning btn-sm">Güncelle</a>
								<a href="<?=SITE?>foto-sil/<?=$veri[$i]["ID"]?>" style="text-align:center;" class="btn btn-danger btn-sm">...Sil...</a>
							</div>
							
							<div class="row">
								<img src="<?=SITE?>images/Fotograflar/<?=$veri[$i]["Resim"]?>" style="width:90%; height:150px; text-align:center;">
							</div>
