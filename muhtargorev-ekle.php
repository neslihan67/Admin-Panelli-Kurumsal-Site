 <div class="content-wrapper">  
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Muhtarlık Görev Ekleme Sayfası</h1>
                </div>
	...
	<div class="container-fluid">
	    <div class="row" style="padding-right:10px;">
	        <div class="col-md-12">
				<a href="<?=SITE?>muhtargorev-liste" class="btn btn-success" style="float:right; margin-bottom:10px;"><i class="fas fa-book-open"> GÖREV LİSTESİ</i></a>
		    </div>    
		</div>
    </div>
		...
		if($_POST)
		{
			if(!empty($_POST["baslik"])&& (!empty($_POST["aciklama"]))) 
			{
				...
				if(!empty($_FILES["resim"]["name"]))
				{
					...
					if($yukle!=false)
					{
						$ekle=$DB->SorguCalistir("INSERT INTO muhtarlikgorev ","SET Baslik=?,Aciklama=?,Resim=?",
						array($baslik,$aciklama,$yukle));
					}
					else
					{
						  ?>
				...
				{
			        $ekle=$DB->SorguCalistir("INSERT INTO muhtarlikgorev ","SET Baslik=?,Aciklama=?",
					array($baslik,$aciklama));
				  }
				  if($ekle!=false)
				  {
					  ?>
	        ...
	        <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="border-color:#f0dc82;" name="baslik" required="required" placeholder="Görev Adı Giriniz ...">
				    </div>
                   ...
                   <div class="form-group">
					<label>Görevin Açıklaması</label> 
