        ...
        <div class="container-fluid">
			...
			<div class="card card-info">
			    ...
			    <div class="card-body">
                    ...
                    <tbody>
				    <?php
				    $veriler=$DB->VeriGetir("koseyazarbilgi","","","ORDER BY ID ASC");
					if($veriler!=false)
					{
				    ...
				    <tr>
					    ...
					    <td><?=$veriler[$i]["Mail"]?></td>
           				...
           				<a href="<?=SITE?>yazar-duzenle/<?=$veriler[$i]["ID"]?>" class="btn btn-warning btn-sm">Güncelle</a>
					    <a href="<?=SITE?>yazar-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-danger btn-sm">Sil</a>
